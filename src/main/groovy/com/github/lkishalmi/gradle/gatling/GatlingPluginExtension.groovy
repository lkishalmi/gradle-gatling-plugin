...
class GatlingPluginExtension implements JvmConfigurable {
    ...
    static final Set<String> DEFAULT_JVM_ARGS = [
        '-server',
        '-Xmx1G',
    ...
    static final Map<String, Object> DEFAULT_SYSTEM_PROPS = ["java.net.preferIPv4Stack": true, "java.net.preferIPv6Addresses": false].asImmutable()
